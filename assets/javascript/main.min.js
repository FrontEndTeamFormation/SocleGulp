!function (e, t) {
    ...
    function r(e) {
        ...
        l.className = l.className.replace(t, "")
    }
    ...
    function o() {
        ...
        var t = e.innerWidth || l.clientWidth, r = e.outerWidth || e.screen.width;
        h.screen.innerWidth = t, h.screen.outerWidth = r, n("w-" + t), i(p.screens, function (e) {
            t > e ? (p.screensCss.gt && n("gt-" + e), p.screensCss.gte && n("gte-" + e)) : t < e ? (p.screensCss.lt && n("lt-" + e), p.screensCss.lte && n("lte-" + e)) : t === e && (p.screensCss.lte && n("lte-" + e), p.screensCss.eq && n("e-q" + e), p.screensCss.gte && n("gte-" + e))
        });
        var o = e.innerHeight || l.clientHeight, s = e.outerHeight || e.screen.height;
        h.screen.innerHeight = o, h.screen.outerHeight = s, h.feature("portrait", o > t), h.feature("landscape", o < t)
    }

    function s() {
        e.clearTimeout(N), N = e.setTimeout(o, 50)
    }

    var a = e.document, u = e.navigator, c = e.location, l = a.documentElement, f = [], p = {
    ...
    if (e.head_conf) for (var d in e.head_conf) e.head_conf[d] !== t && (p[d] = e.head_conf[d]);
    var h = e[p.head] = function () {
        h.ready.apply(null, arguments)
    };
    h.feature = function (e, t, i) {
        return e ? ("[object Function]" === Object.prototype.toString.call(t) && (t = t.call()), n((t ? "" : "no-") + e), h[e] = !!t, i || (r("no-" + e), r(e), h.feature()), h) : (l.className += " " + f.join(" "), f = [], h)
    }, h.feature("js", !0);
    var g = u.userAgent.toLowerCase(), m = /mobile|android|kindle|silk|midp|phone|(windows .+arm|touch)/.test(g);
    h.feature("mobile", m, !0), h.feature("desktop", !m, !0), g = /(chrome|firefox)[ \/]([\w.]+)/.exec(g) || /(iphone|ipad|ipod)(?:.*version)?[ \/]([\w.]+)/.exec(g) || /(android)(?:.*version)?[ \/]([\w.]+)/.exec(g) || /(webkit|opera)(?:.*version)?[ \/]([\w.]+)/.exec(g) || /(msie) ([\w.]+)/.exec(g) || /(trident).+rv:(\w.)+/.exec(g) || [];
    var v = g[1], y = parseFloat(g[2]);
    switch (v) {
        case"msie":
        case"trident":
            v = "ie", y = a.documentMode || y;
            break;
        case"firefox":
            v = "ff";
            break;
    ...
    h.browser = {name: v, version: y}, h.browser[v] = !0;
    for (var x = 0, b = p.browsers.length; x < b; x++) for (var w in p.browsers[x]) if (v === w) {
        n(w);
        for (var T = p.browsers[x][w].min, C = p.browsers[x][w].max, k = T; k <= C; k++) y > k ? (p.browserCss.gt && n("gt-" + w + k), p.browserCss.gte && n("gte-" + w + k)) : y < k ? (p.browserCss.lt && n("lt-" + w + k), p.browserCss.lte && n("lte-" + w + k)) : y === k && (p.browserCss.lte && n("lte-" + w + k), p.browserCss.eq && n("eq-" + w + k), p.browserCss.gte && n("gte-" + w + k))
    } else n("no-" + w);
    n(v), n(v + parseInt(y, 10)), p.html5 && "ie" === v && y < 9 && i("abbr|article|aside|audio|canvas|details|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|progress|section|summary|time|video".split("|"), function (e) {
        a.createElement(e)
    }), i(c.pathname.split("/"), function (e, r) {
        if (this.length > 2 && this[r + 1] !== t) r && n(this.slice(r, r + 1).join("-").toLowerCase() + p.section); else {
            var i = e || "index", o = i.indexOf(".");
            o > 0 && (i = i.substring(0, o)), l.id = i.toLowerCase() + p.page, r || n("root" + p.section)
        }
    }), h.screen = {height: e.screen.height, width: e.screen.width}, o();
    var N = 0;
    e.addEventListener ? e.addEventListener("resize", s, !1) : e.attachEvent("onresize", s)
}(window), function (e, t) {
    ...
    function m(e, t) {
        ...
        if (1 === t.nodeType) {
            if (ve.hasData(e) && (o = ve.access(e), s = ve.set(t, o), c = o.events)) {
                ...
                for (i in c) for (n = 0, r = c[i].length; n < r; n++) Z.event.add(t, i, c[i][n])
            }
    ...
    function q(e, t, n) {
        var r, i, o, s, a, u, c, l, f = this, p = {}, d = e.style, h = e.nodeType && Ce(e), g = ve.get(e, "fxshow");
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], c = Z.css(e, "display"), l = "none" === c ? ve.get(e, "olddisplay") || b(e.nodeName) : c, "inline" === l && "none" === Z.css(e, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", f.always(function () {
    ...
    function O(e, t, n) {
        var r, i, o = 0, s = tt.length, a = Z.Deferred().always(function () {
            ...
            if (i) return !1;
            for (var t = Qe || D(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, s = 0, u = c.tweens.length; s < u; s++) c.tweens[s].run(o);
    ...
    Z.fn = Z.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || Z.isFunction(s) || (s = {}), a === u && (s = this, a--); a < u; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], r = e[t], s !== r && (c && r && (Z.isPlainObject(r) || (i = Z.isArray(r))) ? (i ? (i = !1, o = n && Z.isArray(n) ? n : []) : o = n && Z.isPlainObject(n) ? n : {}, s[t] = Z.extend(c, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, Z.extend({
        expando: "jQuery" + (K + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            if (r) {
                if (a) for (; o < s && (i = t.apply(e[o], r), i !== !1); o++) ; else for (o in e) if (i = t.apply(e[o], r), i === !1) break
            } else if (a) for (; o < s && (i = t.call(e[o], o, e[o]), i !== !1); o++) ; else for (o in e) if (i = t.call(e[o], o, e[o]), i === !1) break;
            return e
        }, trim: function (e) {
            ...
            if (a) for (; o < s; o++) i = t(e[o], o, r), null != i && u.push(i); else for (o in e) i = t(e[o], o, r), null != i && u.push(i);
            return z.apply([], u)
    ...
    var ie = function (e) {
        ...
        function d(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (s) {
                    ...
                    if (u = t[W] || (t[W] = {}), (a = u[r]) && a[0] === B && a[1] === o) return c[2] = a[2];
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[W] && (i = v(i)), o && !o[W] && (o = v(o, s)), r(function (r, s, a, u) {
                var c, l, f, p = [], d = [], h = s.length, v = r || g(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !r && t ? v : m(v, p, e, a, u), x = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, x, a, u), i) for (c = m(x, d), i(c, [], a, u), l = c.length; l--;) (f = c[l]) && (x[d[l]] = !(y[d[l]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            ...
            }]; a < i; a++) if (n = T.relative[e[a].type]) l = [d(h(l), n)]; else {
                if (n = T.filter[e[a].type].apply(null, e[a].matches), n[W]) {
                    for (r = ++a; r < i && !T.relative[e[r].type]; r++) ;
                    return v(a > 1 && h(l), a > 1 && p(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(ue, "$1"), n, a < r && y(e.slice(a, r)), r < i && y(e = e.slice(r)), r < i && p(e))
                }
                l.push(n)
            }
            return h(l)
        ...
        function x(e, n) {
            var i = n.length > 0, o = e.length > 0, s = function (r, s, a, u, c) {
                var l, f, p, d = 0, h = "0", g = r && [], v = [], y = S, x = r || o && T.find.TAG("*", c),
                    b = B += null == y ? 1 : Math.random() || .1, w = x.length;
                for (c && (S = s !== q && s); h !== w && null != (l = x[h]); h++) {
                    if (o && l) {
        ...
        var b, w, T, C, k, N, E, j, S, D, A, L, q, H, O, F, M, P, R, W = "sizzle" + -new Date, $ = e.document, B = 0,
            ...
            ce = new RegExp("^" + re + "*," + re + "*"), le = new RegExp("^" + re + "*([>+~]|" + re + ")" + re + "*"),
        ...
        w = t.support = {}, k = t.isXML = function (e) {
            ...
            return n !== q && 9 === n.nodeType && n.documentElement ? (q = n, H = n.documentElement, O = !k(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function () {
                L()
            ...
            }, M = [], F = [], (w.qsa = ve.test(n.querySelectorAll)) && (i(function (e) {
                ...
                w.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), M.push("!=", ae)
            }), F = F.length && new RegExp(F.join("|")), M = M.length && new RegExp(M.join("|")), t = ve.test(H.compareDocumentPosition), R = t || ve.test(H.contains) ? function (e, t) {
                ...
                for (; u[i] === c[i];) i++;
                return i ? s(u[i], c[i]) : u[i] === $ ? -1 : c[i] === $ ? 1 : 0
            }, n) : q
        }, t.matches = function (e, n) {
            return t(e, null, null, n)
        }, t.matchesSelector = function (e, n) {
            if ((e.ownerDocument || e) !== q && L(e), n = n.replace(fe, "='$1']"), w.matchesSelector && O && (!M || !M.test(n)) && (!F || !F.test(n))) try {
                var r = P.call(e, n);
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        var c, l, f, p, d, h, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (l = m[W] || (m[W] = {}), c = l[e] || [], d = c[0] === B && c[1], p = c[0] === B && c[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();) if (1 === f.nodeType && ++p && f === t) {
                                    l[e] = [B, d, p];
                                    break
                                }
                            } else if (y && (c = (t[W] || (t[W] = {}))[e]) && c[0] === B) p = c[1]; else for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[W] || (f[W] = {}))[e] = [B, p]), f !== t));) ;
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, N = t.tokenize = function (e, n) {
            ...
            for (a = e, u = [], c = T.preFilter; a;) {
                ...
                for (s in T.filter) !(i = he[s].exec(a)) || c[s] && !(i = c[s](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: s,
                    matches: i
                }), a = a.slice(r.length));
            ...
            var i, o, s, a, u, c = "function" == typeof e && e, f = !r && N(e = c.selector || e);
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === t.nodeType && O && T.relative[o[1].type]) {
                    if (t = (T.find.ID(s.matches[0].replace(we, Te), t) || [])[0], !t) return n;
                    c && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (i = he.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);) if ((u = T.find[a]) && (r = u(s.matches[0].replace(we, Te), xe.test(o[0].type) && l(t.parentNode) || t))) {
                    if (o.splice(i, 1), e = r.length && p(o), !e) return Z.apply(n, r), n;
                    break
                }
            }
            return (c || E(e, f))(r, t, !O, n, xe.test(e) && l(t.parentNode) || t), n
    ...
    Z.extend({
        ...
        has: function (e) {
            ...
            for (var n, r = 0, i = this.length, o = [], s = oe.test(e) || "string" != typeof e ? Z(e, t || this.context) : 0; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && Z.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    Z.Callbacks = function (e) {
        ...
        var t, n, r, i, s, a, u = [], c = !e.once && [], l = function (o) {
            for (t = e.memory && o, n = !0, a = i || 0, i = 0, s = u.length, r = !0; u && a < s; a++) if (u[a].apply(o[0], o[1]) === !1 && e.stopOnFalse) {
                t = !1;
                break
            }
        ...
        Deferred: function (e) {
            ...
            if (s > 1) for (t = new Array(s), n = new Array(s), r = new Array(s); i < s; i++) o[i] && Z.isFunction(o[i].promise) ? o[i].promise().done(c(i, r, o)).fail(u.reject).progress(c(i, n, t)) : --a;
    ...
    var Ee = /^key/, je = /^(?:mouse|pointer|contextmenu)|click/, Se = /^(?:focusinfocus|focusoutblur)$/,
        De = /^([^.]*)(?:\.(.+)|)$/;
    Z.event = {
        global: {},
        add: function (e, t, n, r, i) {
            var o, s, a, u, c, l, f, p, d, h, g, m = ve.get(e);
            if (m) for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = Z.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
            ...
            }), t = (t || "").match(de) || [""], c = t.length; c--;) a = De.exec(t[c]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = Z.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = Z.event.special[d] || {}, l = Z.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
                ...
                namespace: h.join(".")
            }, o), (p = u[d]) || (p = u[d] = [], p.delegateCount = 0, f.setup && f.setup.call(e, r, h, s) !== !1 || e.addEventListener && e.addEventListener(d, s, !1)), f.add && (f.add.call(e, l), l.handler.guid || (l.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, l) : p.push(l), Z.event.global[d] = !0)
        },
        remove: function (e, t, n, r, i) {
            var o, s, a, u, c, l, f, p, d, h, g, m = ve.hasData(e) && ve.get(e);
            if (m && (u = m.events)) {
                for (t = (t || "").match(de) || [""], c = t.length; c--;) if (a = De.exec(t[c]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                    for (f = Z.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) l = p[o], !i && g !== l.origType || n && n.guid !== l.guid || a && !a.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (p.splice(o, 1), l.selector && p.delegateCount--, f.remove && f.remove.call(e, l));
        ...
        trigger: function (t, n, r, i) {
            ...
            if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Se.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), d = h.shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[Z.expando] ? t : new Z.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0; (s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, l = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), l && l.apply(s, n), l = c && s[c], l && l.apply && Z.acceptData(s) && (t.result = l.apply(s, n), t.result === !1 && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && f._default.apply(p.pop(), n) !== !1 || !Z.acceptData(r) || c && Z.isFunction(r[d]) && !Z.isWindow(r) && (a = r[c], a && (r[c] = null), Z.event.triggered = d, r[d](), Z.event.triggered = void 0, a && (r[c] = a)), t.result
            }
        },
        dispatch: function (e) {
            e = Z.event.fix(e);
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[i] = s = je.test(i) ? this.mouseHooks : Ee.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new Z.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    var Ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Le = /<([\w:]+)/,
        ...
        Fe = /^$|\/(?:java|ecma)script/i, Me = /^true\/(.*)/, Pe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Re = {
    ...
    Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, Z.extend({
        clone: function (e, t, n) {
            ...
            if (!(Q.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || Z.isXMLDoc(e))) for (s = v(a), o = v(e), r = 0, i = o.length; r < i; r++) y(o[r], s[r]);
            ...
            for (var i, o, s, a, u, c, l = t.createDocumentFragment(), f = [], p = 0, d = e.length; p < d; p++) if (i = e[p], i || 0 === i) if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [i] : i); else if (qe.test(i)) {
                for (o = o || l.appendChild(t.createElement("div")), s = (Le.exec(i) || ["", ""])[1].toLowerCase(), a = Re[s] || Re._default, o.innerHTML = a[1] + i.replace(Ae, "<$1></$2>") + a[2], c = a[0]; c--;) o = o.lastChild;
                Z.merge(f, o.childNodes), o = l.firstChild, o.textContent = ""
            } else f.push(t.createTextNode(i));
            for (l.textContent = "", p = 0; i = f[p++];) if ((!r || Z.inArray(i, r) === -1) && (u = Z.contains(i.ownerDocument, i), o = v(l.appendChild(i), "script"), u && g(o), n)) for (c = 0; i = o[c++];) Fe.test(i.type || "") && n.push(i);
            return l
        ...
        text: function (e) {
            ...
            e = z.apply([], e);
            var n, r, i, o, s, a, u = 0, c = this.length, l = this, f = c - 1, p = e[0], g = Z.isFunction(p);
            if (g || c > 1 && "string" == typeof p && !Q.checkClone && Oe.test(p)) return this.each(function (n) {
                var r = l.eq(n);
                g && (e[0] = p.call(this, n, r.html())), r.domManip(e, t)
            });
            if (c && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                for (i = Z.map(v(n, "script"), d), o = i.length; u < c; u++) s = n, u !== f && (s = Z.clone(s, !0, !0), o && Z.merge(i, v(s, "script"))), t.call(this[u], s, u);
                if (o) for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; u < o; u++) s = i[u], Fe.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Pe, "")))
            }
            return this
        }
    }), Z.each({
    ...
    Z.extend({
        ...
        constructor: S, init: function (e, t, n, r, i, o) {
            ...
            return this.options.duration ? this.pos = t = Z.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e,
                this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : S.propHooks._default.set(this), this
        }
    ...
    Z.fn.extend({
        addClass: function (e) {
            ...
            if (a) for (t = (e || "").match(de) || []; u < c; u++) if (n = this[u], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(at, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : Z.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n) for (var t, r = 0, i = Z(this), o = e.match(de) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else n !== Ne && "boolean" !== n || (this.className && ve.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : ve.get(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    Z.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, s = o ? null : [], a = o ? i + 1 : r.length, u = i < 0 ? a : o ? i : 0; u < a; u++) if (n = r[u], (n.selected || u === i) && (Q.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !Z.nodeName(n.parentNode, "optgroup"))) {
    ...
    ft = xt.exec(pt.toLowerCase()) || [], Z.extend({
        ...
        ajax: function (e, t) {
            ...
            var r, i, o, s, a, u, c, l, f = Z.ajaxSetup({}, t), p = f.context || f,
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || pt) + "").replace(dt, "").replace(yt, ft[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(de) || [""], null == f.crossDomain && (u = xt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === ft[1] && u[2] === ft[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (ft[3] || ("http:" === ft[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), M(bt, f, t, w), 2 === x) return w;
            c = f.global, c && 0 === Z.active++ && Z.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !vt.test(f.type), i = f.url, f.hasContent || (f.data && (i = f.url += (lt.test(i) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = ht.test(i) ? i.replace(ht, "$1_=" + ct++) : i + (lt.test(i) ? "&" : "?") + "_=" + ct++)), f.ifModified && (Z.lastModified[i] && w.setRequestHeader("If-Modified-Since", Z.lastModified[i]), Z.etag[i] && w.setRequestHeader("If-None-Match", Z.etag[i])), (f.data && f.hasContent && f.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", f.contentType), w.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Tt + "; q=0.01" : "") : f.accepts["*"]);
    ...
    Z.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && St.test(this.nodeName) && !jt.test(e) && (this.checked || !ke.test(e))
            }).map(function (e, t) {
                var n = Z(this).val();
    ...
    Z.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Ot, "$1" + i) : t.jsonp !== !1 && (t.url += (lt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
    ...
    Z.offset = {
        setOffset: function (e, t, n) {
            var r, i, o, s, a, u, c, l = Z.css(e, "position"), f = Z(e), p = {};
        ...
        offset: function (e) {
            ...
            if (o) return t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== Ne && (i = r.getBoundingClientRect()), n = B(o), {
